...
@section('page_content')
  <main class="mt-5 pt-3">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-8">
          <h2 class="text-justify" class="font-weight-bold">Torque</h2>
            ...
            <div class="row">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" class="needs-validation" id="form-show">
                          @csrf
                          <select class="form-select" aria-label="pasien Select" name="type" required>
                            <option value="TORQUE" selected>Training Torque</option>
                          </select>
                          <br>
              ...
              <div class="col-12 mb-3">
                <div style="height: 12rem; width:69rem" class="card h-100">
                  <div class="card-header">
                    ...
                    Torque Chart (Shoulder Flexion Extension)
                  </div>
                  <div class="card-body">
                    <canvas id="shoulder-flexion-enxtension-chart" width="1200" height="400"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 mb-3">
                <div style="height: 12rem; width:69rem" class="card h-100">
                  <div class="card-header">
                    <span class="me-2"><i class="bi bi-bar-chart-fill"></i></span>
                    Torque Chart (Shoulder Abduction Adduction)
                  </div>
                  <div class="card-body">
                    <canvas id="shoulder-abduction-adduction-chart" width="1200" height="400"></canvas>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 mb-3">
                <div style="height: 12rem; width:69rem" class="card h-100">
                  <div class="card-header">
                    <span class="me-2"><i class="bi bi-bar-chart-fill"></i></span>
                    Torque Chart (Elbow Flexion Extension)
                  </div>
                  <div class="card-body">
                    <canvas id="elbow-flexion-extension-chart" width="1200" height="400"></canvas>
                  </div>
                </div>
              </div>
...
@section('script_chart')
  <script src="./js/user/torque-script.js"></script>
  <script>
